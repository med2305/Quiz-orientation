  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Erreur lors de la modification du quiz: ' + error.message);
      }
    } catch (error) {
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                ...
                <input
                  type="text"
                  required
                  className="mt-1 text-blue-600 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"
                    ...
                    {question.options.map((option, optionIndex) => (
                      <div key={optionIndex} className="flex items-center space-x-4">
                        ...
                        <input
                          ...
                          className="text-blue-600 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"
                          value={option}
                          onChange={(e) =>
